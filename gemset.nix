{
  ...
  aws-partitions = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "111zmq3ppixbbzz6wanral2fm7i3bimj6if7ndkdd8ym195rxkaa";
      type = "gem";
    };
    version = "1.756.0";
  };
  ...
  fastlane-plugin-browserstack = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "09921h26xh948sw6aa6yscjcz3m99r26sndyc3bb6ldarynw7l7r";
      type = "gem";
    };
    version = "0.3.2";
  };
  ...
  google-apis-androidpublisher_v3 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "02fyrw75p0638scxhc6mhpfrx6grf7p59p9ryjldpb79mh6hy6f0";
      type = "gem";
    };
    version = "0.40.0";
  };
