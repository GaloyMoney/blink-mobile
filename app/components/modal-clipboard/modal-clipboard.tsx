    ...
    >
      ...
      <SafeAreaView style={styles.modalForeground}>
        ...
        <View style={styles.buttonContainer}>
          <Button title={translate("ModalClipboard.dismiss")} onPress={dismiss} buttonStyle={styles.buttonStyle} />
          <Button title={translate("ModalClipboard.open")} onPress={open} buttonStyle={styles.buttonStyle} />
        </View>
      </SafeAreaView>
    </Modal>
  )
