...
export default {
  ...
  decorators: [
    Story => <IsAuthedContextProvider value={true}><StoryScreen>{Story()}</StoryScreen></IsAuthedContextProvider>
  ],
} as ComponentMeta<typeof EarnSection>

export const Start = () =>  <MockedProvider mocks={mocksSection0} cache={createCache()}><EarnSection route={route}/></MockedProvider>
