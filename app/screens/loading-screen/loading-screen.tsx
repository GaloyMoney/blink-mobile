...
export const LoadingScreen = withNavigation(inject("dataStore")(observer(
...
const onAuthStateChanged = async (user) => { // TODO : User type
    ...
    if (user === null) { // new install or no data yet
    navigation.navigate('authStack')
    } else if (user.emailVerified === true) {
    navigation.navigate('authStack') // we are logged in and email verified
    } else if (user.phoneNumber) { // we may be onboarding
