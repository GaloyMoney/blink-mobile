...
export default {
  ...
  decorators: [
    (Story) => <MockedProvider mocks={mocks} cache={createCache()}><StoryScreen>{Story()}</StoryScreen></MockedProvider>
  ]
                      ...
                      "edges": [
                          ...
                          },
                          {
                              ...
                              "node": {
                                  ...
                                  "initiationVia": {
                                      "paymentHash": "9d0bf1eb42753c5a1991998c7cc06ace22ce119cdff4c0a7095284ccaf48e847",
...
export const Unauthed = () =>  <IsAuthedContextProvider value={false}><HomeScreen /></IsAuthedContextProvider>
export const Authed = () =>  <IsAuthedContextProvider value={true}><HomeScreen /></IsAuthedContextProvider>
