      ...
      >
        ...
        <View style={{ flex: 1, paddingHorizontal: 30, width: '100%' }}>
          <ScrollView>
            ...
            <Row containerStyle={{ marginTop: 15, alignItems: 'center', alignSelf: 'center' }}>
              <CurrentLocation />
              <Text style={[styles.location, { marginLeft: 10 }]} numberOfLines={1}>{getLocation(location)}</Text>
            </Row>
            <CustomTextInput
              placeHolder={'Account contact will be filled'}
...
const styles = StyleSheet.create({
  rightComponent:{
    width: 42, backgroundColor: 'rgba(69, 155, 13, 0.3)', justifyContent: 'center', alignItems: 'center',
    borderRadius:3
  },
  orText: { fontFamily: typography.bold, color: '#767676', fontSize: fontSize.font13, marginTop: 20, marginBottom: 10, alignSelf: 'center' },
  selected: {
