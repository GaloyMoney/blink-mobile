...
export type CreateExternalWalletResponse = {
  readonly __typename: "CreateExternalWalletResponse"
  readonly currencyId?: Maybe<Scalars["Int"]>
  readonly id: Scalars["ID"]
...
export type ExternalWalletTransactionsArgs = {
  after?: InputMaybe<Scalars["String"]>
  before?: InputMaybe<Scalars["String"]>
  first?: InputMaybe<Scalars["Int"]>
  last?: InputMaybe<Scalars["Int"]>
...
export type ExternalWalletTransactionsByAddressArgs = {
  address: Scalars["OnChainAddress"]
  after?: InputMaybe<Scalars["String"]>
  before?: InputMaybe<Scalars["String"]>
  first?: InputMaybe<Scalars["Int"]>
...
export type ExternalWalletAuthRefreshResponse = {
  readonly __typename: "ExternalWalletAuthRefreshResponse"
  readonly accessToken: Scalars["String"]
  readonly expiresAt: Scalars["Int"]
}

export type ExternalWalletCredentials = {
  readonly email: Scalars["String"]
  readonly password: Scalars["String"]
}

export type ExternalWalletDetails = {
  readonly __typename: "ExternalWalletDetails"
...
export type ExternalWalletSignInResponse = {
  readonly __typename: "ExternalWalletSignInResponse"
  readonly accessToken: Scalars["String"]
  readonly accessTokenExpiresAt: Scalars["Int"]
  readonly refreshToken: Scalars["String"]
  readonly refreshTokenExpiresAt: Scalars["Int"]
}
...
export type IbexWallet = ExternalWallet &
  Wallet & {
...
/** A wallet belonging to an account which contains a USD balance and a list of transactions. */
export type IbexWalletTransactionsArgs = {
  after?: InputMaybe<Scalars["String"]>
  before?: InputMaybe<Scalars["String"]>
  first?: InputMaybe<Scalars["Int"]>
  last?: InputMaybe<Scalars["Int"]>
...
/** A wallet belonging to an account which contains a USD balance and a list of transactions. */
export type IbexWalletTransactionsByAddressArgs = {
  address: Scalars["OnChainAddress"]
  after?: InputMaybe<Scalars["String"]>
  before?: InputMaybe<Scalars["String"]>
  first?: InputMaybe<Scalars["Int"]>
...
export type Mutation = {
  ...
  readonly createExternalWallet: CreateExternalWalletResponse
  readonly deviceNotificationTokenCreate: SuccessPayload
  readonly getExternalWalletToken: ExternalWalletSignInResponse
  /**
  ...
  readonly refreshExternalWalletToken: ExternalWalletAuthRefreshResponse
...
export type MutationCreateExternalWalletArgs = {
  credentials: CreateExternalWalletInput
}
...
export type MutationGetExternalWalletTokenArgs = {
  credentials: ExternalWalletCredentials
}
...
export type MutationRefreshExternalWalletTokenArgs = {
...
export type QueryExternalWalletByIdArgs = {
  accountId: Scalars["ID"]
}

export type QueryGetExternalWalletDetailsArgs = {
  accountId: Scalars["ID"]
}
...
export type MyExtWalletsFragment = {
  readonly __typename: "ConsumerAccount"
  readonly externalWallets: ReadonlyArray<{
    readonly __typename: "IbexWallet"
    readonly id: string
    readonly balance: number
    readonly walletCurrency: WalletCurrency
...
export type UserLoginDeviceMutation = {
  readonly __typename: "Mutation"
  readonly userLoginDevice: {
    readonly __typename: "JwtPayload"
...
export type ReceiveWrapperScreenQuery = {
  readonly __typename: "Query"
  readonly me?: {
    readonly __typename: "User"
    readonly id: string
    readonly defaultAccount: {
      ...
      readonly defaultWallet?:
        ...
        | { readonly __typename: "IbexWallet"; readonly walletCurrency: WalletCurrency }
  ...
  readonly me?: {
    ...
    readonly defaultAccount: {
      ...
      readonly wallets: ReadonlyArray<
        ...
        | { readonly __typename: "IbexWallet"; readonly id: string }
...
`
export const MyExtWalletsFragmentDoc = gql`
...
`
export type UserLoginDeviceMutationFn = Apollo.MutationFunction<
  UserLoginDeviceMutation,
  UserLoginDeviceMutationVariables
>
 ...
 * });
 */
export function useUserLoginDeviceMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UserLoginDeviceMutation,
    UserLoginDeviceMutationVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<UserLoginDeviceMutation, UserLoginDeviceMutationVariables>(
    UserLoginDeviceDocument,
    options,
  )
}
export type UserLoginDeviceMutationHookResult = ReturnType<
  typeof useUserLoginDeviceMutation
>
export type UserLoginDeviceMutationResult = Apollo.MutationResult<UserLoginDeviceMutation>
export type UserLoginDeviceMutationOptions = Apollo.BaseMutationOptions<
  UserLoginDeviceMutation,
  UserLoginDeviceMutationVariables
>
 ...
 * });
 */
export function useReceiveWrapperScreenQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ReceiveWrapperScreenQuery,
    ReceiveWrapperScreenQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ReceiveWrapperScreenQuery, ReceiveWrapperScreenQueryVariables>(
    ReceiveWrapperScreenDocument,
    options,
  )
}
export function useReceiveWrapperScreenLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ReceiveWrapperScreenQuery,
    ReceiveWrapperScreenQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    ReceiveWrapperScreenQuery,
    ReceiveWrapperScreenQueryVariables
  >(ReceiveWrapperScreenDocument, options)
}
export type ReceiveWrapperScreenQueryHookResult = ReturnType<
  typeof useReceiveWrapperScreenQuery
>
export type ReceiveWrapperScreenLazyQueryHookResult = ReturnType<
  typeof useReceiveWrapperScreenLazyQuery
>
export type ReceiveWrapperScreenQueryResult = Apollo.QueryResult<
  ReceiveWrapperScreenQuery,
  ReceiveWrapperScreenQueryVariables
>
