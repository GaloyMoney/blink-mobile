...
describe("no amount lightning payment details", () => {
    ...
    it("properly sets fields with all arguments provided", () => {
        ...
        expect(paymentDetails).toEqual(expect.objectContaining({
            ...
            settlementAmount: defaultParams.convertPaymentAmount(defaultParams.destinationSpecifiedAmount, defaultParams.sendingWalletDescriptor.currency),
            unitOfAccountAmount: defaultParams.convertPaymentAmount(defaultParams.destinationSpecifiedAmount, defaultParams.unitOfAccount),
