...
describe("amount lightning payment details", () => {
    ...
    it('properly sets fields with all arguments provided', () => {
        ...
        expect(paymentDetails).toEqual(expect.objectContaining({
            ...
            settlementAmount: defaultParams.convertPaymentAmount(defaultParams.paymentRequestAmount, defaultParams.sendingWalletDescriptor.currency),
            unitOfAccountAmount: defaultParams.convertPaymentAmount(defaultParams.paymentRequestAmount, defaultParams.unitOfAccount),
