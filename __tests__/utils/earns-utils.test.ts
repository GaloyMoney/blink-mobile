...
const expectedEnglishQuizSections = [
  ...
  {
    section: {
      id: "AttributesOfAGoodStoreOfValue",
  ...
  {
    section: {
      id: "TheEvolutionOfMoneyII",
      title: "The Evolution of Money II",
    },
    content: [
      {
        id: "notFromGovernment",
  ...
  {
    section: {
      id: "BitcoinCriticismsFallaciesI",
  ...
  {
    section: {
      id: "BitcoinCriticismsFallaciesII",
  ...
  {
    section: {
      id: "BitcoinCriticismsFallaciesIII",
      title: "Bitcoin Criticisms & Fallacies III",
    },
    content: [
      {
        id: "concentratedOwnership",
